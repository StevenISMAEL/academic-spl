...
<?php $component->withAttributes([]); ?>
    <div style="margin-bottom: 1.5rem;">
        ...
        <?php $limite = \App\Core\Services\FeatureGate::setting('max_enrollments_per_period', 'N/A'); ?>
        <p style="color: #64748b; font-size: 0.875rem; margin: 0.25rem 0 0;">
            Límite de materias por período configurado: <strong><?php echo e($limite); ?></strong>
        </p>
    </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $matriculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-bottom: 1px solid #f1f5f9;">
                                    <td style="padding: 0.75rem 1rem; color: #111827;"><?php echo e($m['persona_id'] ?? '-'); ?></td>
                                    <td style="padding: 0.75rem 1rem; color: #111827;"><?php echo e($m['curso_id'] ?? '-'); ?></td>
                                    <td style="padding: 0.75rem 1rem;">
                                        <?php $estado = strtolower($m['estado'] ?? ''); ?>
                                        ...
                                        <?php else: ?>
                                            <span style="background:#f3f4f6;color:#374151;font-size:0.75rem;padding:0.25rem 0.75rem;border-radius:9999px;font-weight:600;"><?php echo e($m['estado'] ?? '-'); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td style="padding: 0.75rem 1rem; text-align: center;">
                                        
                                        <form action="/enrollment/<?php echo e($m['id']); ?>/status" method="POST" style="display: inline-flex; gap: 0.5rem; align-items: center;">
                                        ...
                                        <form action="/enrollment/<?php echo e($m['id']); ?>" method="POST" style="display: inline-block; margin-left: 0.25rem;">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.entity-form','data' => ['fields' => [
                ...
                ],'action' => '/enrollment','submitLabel' => 'Inscribir']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['fields' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    ['name' => 'persona_id', 'type' => 'select', 'label' => 'Estudiante', 'required' => true, 'options' => $personas],
                    ['name' => 'curso_id',   'type' => 'select', 'label' => 'Curso',      'required' => true, 'options' => $cursos]
                ]),'action' => '/enrollment','submitLabel' => 'Inscribir']); ?>
            ...
            <?php if($errors->has('limite')): ?>
                <div style="margin-top: 1rem; background: #fef3c7; border: 1px solid #fcd34d; border-radius: 0.5rem; padding: 1rem;">
                    ...
                    <p style="margin: 0.25rem 0 0; color: #78350f; font-size: 0.813rem;">
                        <?php echo e($errors->first('limite')); ?>
...
<?php endif; ?>
<?php /**PATH D:\Octavo\FABRICA\ProyectoFinal\academic-spl\core_assets\frontend\laravel-shell\app\Modules/EnrollmentModule/resources/views/index.blade.php ENDPATH**/ ?>